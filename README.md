...
To run tests with Postgres, you need to edit _config/config.cjs_ and under the `test` key comment out the use of SQLite and uncomment the environment variables
...
The project includes Docker configuration for running the application and PostgreSQL database.
...
Remove containers and volumes (including the database):
